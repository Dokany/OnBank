...
class LoginController: UIViewController {
    ...
    let loginButton: UIButton = {
        ...
        l.backgroundColor = UIColor.rgb(r: 11, g: 37, b: 69)
        return l
    }()
    ...
    let haveAccountButton: UIButton = {
        ...
        let attributedTitle = NSMutableAttributedString(string:
            "Not registered? ", attributes: [NSAttributedStringKey.foregroundColor:
                color, NSAttributedStringKey.font : font ])
        
        attributedTitle.append(NSAttributedString(string: "Sign Up Here", attributes:
            [NSAttributedStringKey.foregroundColor: UIColor.white,
    ...
    fileprivate func setupPasswordField() {
        ...
        passwordTextField.anchors(top: emailTextField.bottomAnchor, topPad: 30, bottom: nil,
    ...
    fileprivate func setupLoginButton() {
        ...
        loginButton.anchors(top: passwordTextField.bottomAnchor, topPad: 50, bottom: nil,
